...
localparam logic [3:0] ST_SPAWN    = 4'd0;
localparam logic [3:0] ST_NEXT     = 4'd1;
localparam logic [3:0] ST_PLAY     = 4'd2;
localparam logic [3:0] ST_EVAL     = 4'd3;
localparam logic [3:0] ST_FALL     = 4'd4;
localparam logic [3:0] ST_LOCK     = 4'd5;
localparam logic [3:0] ST_SCAN     = 4'd6;
localparam logic [3:0] ST_SHIFT    = 4'd7;
localparam logic [3:0] ST_GAMEOVER = 4'd8;
        ...
        case (piece_type)
            ...
            3'd3: begin                                                                           // J
                case (piece_rot)
                    ...
                    2'd1: get_shape = 16'b0000_1110_1000_0000;
                    2'd2: get_shape = 16'b0000_1100_0100_0100;
                    default: get_shape = 16'b0000_0010_1110_0000;
                endcase
            end
            3'd4: begin                                                                           // L
                case (piece_rot)
...
always_comb begin
    ...
    next_select_mask = (bag_mask == 7'b000_0000) ? FULL_BAG : bag_mask;
    selected_next_piece = select_bag_piece(next_select_mask, rng_lfsr);
    ...
    fall_accepted = !pending_fall_attempt || (state != ST_FALL) ||
                    !check_shape_collision(active_shape, active_x, pending_y + 6'd1);
end
...
always_comb begin
    ...
    if (query_valid && ((state == ST_NEXT) || (state == ST_PLAY) ||
                        (state == ST_EVAL) || (state == ST_FALL))) begin
